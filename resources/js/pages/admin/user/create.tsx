            ...
            <div className="p-4 sm:p-6 lg:p-8 flex-1 overflow-auto">
              <div className="max-w-2xl mx-auto">
                <div className="mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Create New User</h2>
                              ...
                              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5, ml: 1 }}>
                                {selected.map((roleName) => (
                                  <Chip
                                    ...
                                    label={roleName}
                                    size="small"
                                    onDelete={defaultUserRoleName === roleName && data.roles.length === 1 ? undefined : () => handleRemoveRole(roleName)}
                                    deleteIcon={defaultUserRoleName === roleName && data.roles.length === 1 ? null : <X className="w-3 h-3" />}

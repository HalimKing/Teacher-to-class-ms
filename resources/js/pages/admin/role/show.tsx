...
const ShowRolePage = ({ role }: ShowRolePageProps) => {
  ...
  const formatGroupName = (groupName: string) => {
    const labels: Record<string, string> = {
      ...
      'admin.attendance': 'Teaching Staff',
      'admin.staff-attendance': 'Non-Teaching Staff',
      'admin.teachers': 'Staff',
      'admin.user-management': 'User Management',
      'admin.academics': 'Schedules',
      ...
      <div className="min-w-0 p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6">
            <Link
              href="/admin/user-management/roles"
              className="mb-4 inline-flex items-center text-sm text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-300"
            >
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex min-w-0 items-center gap-4">
                <div className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-r sm:h-16 sm:w-16 ${
                ...
                <div className="min-w-0">
                  <h1 className="text-2xl font-bold break-words text-slate-900 sm:text-3xl dark:text-white">{role.name}</h1>
              ...
              <div className="flex">
                <Link
                  ...
                  className="inline-flex h-11 w-full items-center justify-center rounded-xl bg-gradient-to-r from-indigo-600 to-purple-700 px-4 py-2 font-medium text-white shadow-md transition-all duration-200 hover:from-indigo-700 hover:to-purple-800 hover:shadow-lg sm:w-auto"
                >
                    ...
                    >
                      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <h3 className="font-bold break-words text-slate-900 capitalize dark:text-white">
                        ...
                        {permissions.map(permission => (
                          ...
                          >
                            <div className="min-w-0">
                              ...
                              <div className="mt-1 font-mono text-xs break-all text-slate-500 dark:text-slate-400">
                                {permission.name}
                              </div>
                            </div>
                            <div className="flex items-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
              ...
              <div className="space-y-4">
                <div className="flex flex-col gap-2 border-b border-slate-100 py-3 sm:flex-row sm:items-center sm:justify-between dark:border-slate-700">
                ...
                <div className="flex flex-col gap-2 border-b border-slate-100 py-3 sm:flex-row sm:items-center sm:justify-between dark:border-slate-700">
                  ...
                  <span className="font-medium break-words text-slate-900 dark:text-white">{role.name}</span>
                </div>

...
//   const [errors, setErrors] = useState<FormErrors>({});
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    post(route('admin.school-management.academic-periods.store'))
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200">
            <div className="p-6 border-b border-slate-200">
              <h1 className="text-2xl font-bold text-slate-900">Create New Academic Period</h1>
              <p className="mt-1 text-sm text-slate-500">Fill in the details to create a new academic period.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="flex justify-end space-x-4 pt-6 border-t">
                ...
                >{processing ? 'Creating...' : 'Create Academic Period'}</Button>

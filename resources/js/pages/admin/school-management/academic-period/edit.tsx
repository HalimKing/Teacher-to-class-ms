...
const EditAcademicPeriodPage = ({ academicPeriod }: { academicPeriod: AcademicPeriod }) => {
...
//   const [errors, setErrors] = useState<FormErrors>({});
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    put(route('admin.school-management.academic-periods.update', academicPeriod.id))
  ...
  const breadcrumbs = [
    ...
    },
    {
      ...
      href: '/admin/school-management/academic-periods/' + academicPeriod.id + '/edit',
    }
  ];

  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Edit Academic Period" />
      
      <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200">
            <div className="p-6 border-b border-slate-200">
              <h1 className="text-2xl font-bold text-slate-900">Edit Academic Period</h1>
            </div>
...
export default EditAcademicPeriodPage;
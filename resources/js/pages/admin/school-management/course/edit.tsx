...
const EditCoursePage = ({ 
  ...
  const currentTeacherOption = course.teacher_id ? 
    teacherOptions.find(option => option.value === course.teacher_id) || null : null;
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Core courses are mandatory, elective courses are optional
                  </p>
                </div>
              </div>
                ...
                <label className="block text-sm font-medium text-slate-700 mb-2">
                  ...
                  {selectedTeacher && (
                    <span className="ml-2 text-xs text-green-600 font-normal">
                      Currently: {selectedTeacher.label}
                    </span>
                  )}
                </label>
                <ComboBox
                      ...
                      <div>
                        ...
                        {course.teacher.employee_id && (
                          <p className="text-xs text-green-600">
                            Employee ID: {course.teacher.employee_id}
                          </p>
                        )}
                      </div>
                    </div>
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl">
                <h3 className="text-lg font-medium text-blue-800 mb-3">Course Summary</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      <span className="font-medium">Type:</span> {data.course_type === 'core' ? 'Core (Mandatory)' : 'Elective (Optional)'}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-blue-700">

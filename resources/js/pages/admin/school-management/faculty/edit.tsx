...
const CreateFacultyPage = ({faculty}: {faculty: FormData | any}) => {
...
//   const [errors, setErrors] = useState<FormErrors>({});
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    put(route('admin.school-management.faculties.update', faculty.id))
  ...
  const breadcrumbs = [
    ...
    {
      title: 'Edit Faculty',
      href: '/admin/school-management/faculty/edit',
    }
  ];
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200">
            <div className="p-6 border-b border-slate-200">
              <h1 className="text-2xl font-bold text-slate-900">Edit Faculty</h1>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  className={`w-full px-4 py-2.5 border ${errors.description ? 'border-red-500' : 'border-slate-300'} rounded-sm focus:ring-2 focus:ring-cyan-600 focus:border-transparent outline-none`}
                />
                {errors.description && (
                  <p className="mt-1 text-sm text-red-500 flex items-center">
                    <AlertCircle className="w-4 h-4 mr-1" />

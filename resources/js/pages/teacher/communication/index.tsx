        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4 md:p-6">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">Unit Communication</h1>
                        <p className="mt-1 text-sm text-slate-500">{capabilities.scope_label}</p>
                    </div>
                    <div className="flex flex-wrap gap-2">
                        <Link href={route('teacher.communication.inbox')} className="rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700">
                            Inbox
                        </Link>
                ...
                <section className="rounded-xl border border-slate-200 bg-white">
                    <div className="border-b border-slate-100 px-4 py-3 text-sm font-semibold text-slate-900">Recent messages</div>
                    {recent.length === 0 ? (
                        <div className="px-4 py-12 text-center text-sm text-slate-500">You have not sent any unit messages yet.</div>
                    ) : (

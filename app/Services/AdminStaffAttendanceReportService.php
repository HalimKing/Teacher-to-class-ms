...
class AdminStaffAttendanceReportService
{
    ...
    public function getAnalytics(Request $request): array
    {
        ...
        return [
            'dailyTrend' => $this->groupTrend($records, 'day'),
            'weeklyTrend' => $this->groupTrend($records, 'week'),
            'monthlyTrend' => $this->groupTrend($records, 'month'),
    ...
    public function getFilterOptions(): array
    {
        return [
            ...
            'attendanceStatuses' => ['pending', 'checked_in', 'completed', 'late', 'early_leave', 'overtime', 'incomplete'],
            'arrivalCategories' => [
    ...
    private function groupTrend(Collection $records, string $period): array
    {
        return $records->groupBy(function (StaffAttendance $record) use ($period) {
        ...
        })->map(function (Collection $group, string $label) use ($period) {

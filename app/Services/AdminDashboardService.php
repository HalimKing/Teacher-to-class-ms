...
class AdminDashboardService
{
    ...
    private function welcomeData(): array
    {
        ...
        return [
            ...
            'systemName' => \App\Models\SystemSetting::appName(),
        ];
    }
    ...
    private function kpiCards(Carbon $today): array
    {
        ...
        $pendingVenueRequests = VenueChangeRequest::query()->pending()->count();
        ...
        return [
            ...
            ['title' => 'Pending Venue Change Requests', 'value' => (string) $pendingVenueRequests, 'change' => 'Awaiting approval', 'changeType' => $pendingVenueRequests > 0 ? 'negative' : 'neutral', 'icon' => 'MapPin', 'group' => 'attendance'],
